...
system.secret-key: '{{ vault_sentry_secret_key }}'
...
slack.client-id: '{{ vault_slack_client_id }}'
slack.client-secret: '{{ vault_slack_client_secret }}'
slack.signing-secret: '{{ vault_slack_signing_secret }}'
...
# Google SSO #
#####################
auth-google.client-id: '{{ vault_google_client_id }}'
auth-google.client-secret: '{{ vault_google_client_secret }}'